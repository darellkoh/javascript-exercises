...
// Version 1: Using an Object Constructor (my attempt) 	
	...
	var obj = {score: 0};
		for(var prop in arr[i]) {
			if(prop === "name") {
				...
				obj.score += (arr[i][prop] * 2); 
			} else if (prop === "cheeseburger") {
				obj.score += (arr[i][prop] * 5); 
			} else {
				obj.score += (arr[i][prop] * 3); 
			}
		}
		newArr.push(obj); 
	}
